 ...
 * https://github.com/Aaron-P/html5sortable
 * https://github.com/makepanic/html5sortable
 *
        ...
        return this.each(function () {
            ...
            items.attr('draggable', 'true').on('dragstart.h5s', function (e) {
                ...
                if (items.is(this)) {
                    ...
                    var thisIndex = $this.index(), placeholderIndex = placeholder.index();
                    if (options.forcePlaceholderSize) {
                        placeholder.height(draggingHeight);
                    }

                    if (options.checkDeadZone) {
                    ...
                    dragging.hide();
                    $this[placeholderIndex < thisIndex ? 'after' : 'before'](placeholder);
